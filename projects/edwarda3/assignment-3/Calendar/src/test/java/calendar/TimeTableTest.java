...
public class TimeTableTest {
	 ...
	 @Test
	  public void test01()  throws Throwable  {
		 ...
		 Appt appt4 = new Appt(3,1,3,1,2018,"test4","Test4 appt");
		 int[] rdays = {2,3,4};
		 appt2.setRecurrence(rdays,Appt.RECUR_BY_WEEKLY,2,Appt.RECUR_NUMBER_FOREVER);
		 appt4.setRecurrence(rdays,Appt.RECUR_BY_WEEKLY,2,Appt.RECUR_NUMBER_FOREVER);
		 LinkedList<Appt> lla = new LinkedList<Appt>();
		 lla.add(appt); lla.add(appt2); lla.add(appt3); lla.add(appt4);
		 LinkedList<CalDay> cd = tt.getApptRange(lla,newyears,newyears2);
		 assertTrue(cd.getFirst().isValid());



		 LinkedList<Appt> emptylla = new LinkedList<Appt>();
		 TimeTable tterror = new TimeTable();
		 tterror.getApptRange(emptylla,newyears,newyears2);
		 Appt invalidAppt = new Appt(-1,1,1,1,1,"invalid","This is an invalid object");
		 emptylla.add(invalidAppt);
		 tterror.getApptRange(emptylla,newyears, newyears2);
	 }
